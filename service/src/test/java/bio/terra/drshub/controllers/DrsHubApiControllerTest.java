...
public class DrsHubApiControllerTest extends BaseTest {
  ...
  @Test // 28
  // todo check if it's calling the fence link, check shouldFetchFenceAccessToken
  void testCallsBondWithFenceProviderWhenHostIsBioDataCatalyst() throws Exception {
    var provider = "bioDataCatalyst";
    var compactIdAndHost = getProviderHosts(provider);
