...
@Slf4j
public class DiscoverabilityEndpoint extends TestScript {
  private static String TDR_TEST_DRS_URI =
      "drs://jade.datarepo-alpha.broadinstitute.org/v1_93dc1e76-8f1c-4949-8f9b-07a087f3ce7b_8b07563a-542f-4b5c-9e00-e8fe6b1861de";

  private static String TDR_PASSPORT_DRS_URI = "";
  private static String TDR_BASIC_DRS_URI = "";
